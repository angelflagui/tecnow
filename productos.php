...
$sql = "SELECT id, producto, descripcion, precio, imagen, categoria_id, marca_id, stock FROM productos";
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#modal_<?php echo $row['id']; ?>" class="btn-open-popup">Ver
                                                    más</a>
                                                <div class="container-all" id="modal_<?php echo $row['id']; ?>">
                                                    <div class="popup">
                                                        ...
                                                        <h3> <?php echo $row['producto']; ?> </h3>
                                                            <h1> Descripción de producto <br>
                                                                <?php echo $row['descripcion']; ?> </h1>
                                                            <h1> Stock: <?php echo $row['stock']; ?> </h1>
                                                            <h1> Precio: $<?php echo $row['precio']; ?> </h1>
                                                            <a href="contacto.php"><button type="button" class="btn btn-success">Comprar</button></a>
                                                        </div>
