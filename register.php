                ...
                <div class="row gtr-200">
                    <div class="wrapper">
                        <div class="register-header text-center">
                            <br>
                            <h2>Registro</h2>
                            <h4>Llene los campos para crear su cuenta.</h4>
                        ...
                        <div class="row h-100 justify-content-center align-items-center">
                            ...
                            <div class="btn center p-5">
                                <input type="submit" class="btn btn-danger m-4" value="REGISTRAR">
                                <input type="reset" class="btn btn-secondary m-4" value="REINICIAR REGISTRO">
                                <br><br>
